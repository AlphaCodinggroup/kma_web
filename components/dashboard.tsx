...
import { BarChart3, Users, FileText, CheckCircle, ClipboardList, FolderOpen, Building, GitBranch } from "lucide-react"
      ...
      <div className="flex">
        ...
        <main className="flex-1 p-6">
          <Tabs value={activeTab} onValueChange={setActiveTab}>
            ...
            {/* Buildings Management - Solo para administradores */}
            {currentUser.role === "administrator" && (
