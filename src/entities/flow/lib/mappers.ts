...
function mapSelectStep(dto: SelectStepDTO): SelectStep {
  return {
    ...
    options: dto.options.map((o) => ({
      label: o.label,
      next: o.next,
      barrierId: o.barrier_id ?? undefined,
      yesNext: o.yes_next ?? undefined,
      noNext: o.no_next ?? undefined,
      condition: o.condition ? mapConditionDTO(o.condition) : undefined,
    })),
    next: dto.next ?? "",
    image: dto.image ?? "",
    images: normalizeImages(dto.image, dto.images),
...
function mapSelectStepToDTO(step: SelectStep): SelectStepDTO {
  return {
    ...
    options: step.options.map((o) => ({
      label: o.label,
      next: o.next,
      barrier_id: o.barrierId,
      yes_next: o.yesNext,
      no_next: o.noNext,
      condition: o.condition ? mapConditionToDTO(o.condition) : undefined,
    })),
    next: step.next || undefined,
    image: step.images && step.images.length > 0 ? step.images[0] : undefined,
    images: step.images || undefined,
